                    ...
                    IEEE80211_SCAN_ID        *scan_id)
{
    ...
    *scan_id =  *scan_id | WMI_HOST_SCAN_REQ_ID_PREFIX ;
	...
	ic->ic_cur_min_dwell			  = ss->ss_min_dwell_active;
	ic->ic_scan_vap					  = vap;
#endif
...
#if ATOPT_RESTRAIN_QUEUE
	//params->flags |= IEEE80211_SCAN_OFFCHAN_MGMT_TX;
#endif
...
#if ATOPT_RESTRAIN_QUEUE
		ic->ic_5g_foreign_chan = (ol_ath_find_full_channel(ic, wmi_scn_event->channel_freq))->ic_ieee;
		OS_SET_TIMER(&(ss->ss_ic->ic_restrain_5g_timer), 2);
#endif
        break;
