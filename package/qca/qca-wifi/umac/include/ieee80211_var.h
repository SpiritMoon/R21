...
#define ATH_HMMC_CNT_MAX 8
	...
	u_int8_t                             ic_utiltimer_en; //added by pengdecai chan utilization timer enable
	...
	struct timer_list ic_restrain_2g_timer;
	struct timer_list ic_restrain_5g_timer;
	u_int32_t	ic_cur_min_dwell;
	u_int16_t	ic_5g_foreign_chan;
	struct ieee80211vap *ic_scan_vap;
#endif
...
/*End:pengdecai for han private wmm*/
	...
	u_int8_t		iv_monitor; //zhaoyang modifies for background scanning 2016-03-21
#endif

#if ATOPT_DCM
u_int8_t iv_lowrssi_threshold; 
u_int32_t iv_lowrssi_refuse;
#endif
