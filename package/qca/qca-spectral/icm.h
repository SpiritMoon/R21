...
typedef struct icm_info {
    ...
    int acs_force;
    int acs_selection;
    int acs_last_channel;
    pthread_t acs_control_scan_thread;
    /*acs control*/
    /*atp control*/
    int atp_enable;
    int current_txpower;
...
#define DEFAULT_CONFIG_FILE     "/etc/ath/drm.conf"
...
#define DEFAULT_ID_0_RADIO_IFNAME   "wifi0"
#define DEFAULT_ID_1_RADIO_IFNAME   "wifi1"
...
extern void signal_handler(int signals);
#endif  /* __ICM_H__ */
