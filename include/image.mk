...
define Image/mkfs/create_pub_cfgs
...
define Image/mkfs/prepare/default
	...
	chmod 0700 $(TARGET_DIR)/etc/cert
	chmod 0400 $(TARGET_DIR)/etc/cert/CAhan.key
	chmod 0700 $(TARGET_DIR)/etc/init.d/cert
endef
...
define BuildImage
  ...
  ifeq ($(IB),)
    install: compile install-targets FORCE
		...
		$(call Image/mkfs/create_pub_cfgs)
