                       ...
                       scan_request_data_t *request_data)
{
	...
	ss->ss_ic->ic_cur_min_dwell		  = ss->ss_cur_min_dwell;
	ss->ss_ic->ic_scan_vap			  = vaphandle;
#endif
...
#if ATOPT_RESTRAIN_QUEUE
	OS_SET_TIMER(&(ss->ss_ic->ic_restrain_2g_timer), 2);
#endif
...
#define HW_DEFAULT_REPEAT_PROBE_REQUEST_INTVAL                          10
