...
struct apuser {
    ...
    unsigned char is_iptables;
    unsigned char con_statics;
    unsigned char con_time;
};
...
#define UM_USER_POLICY_INITER  { \
    ...
    UM_POLICY_INITER(UM_USER_MODE,          "mode",         INT32), \
    ...
    UM_POLICY_INITER(UM_USER_UP_RATE,       "up_rate",      INT32),\
    UM_POLICY_INITER(UM_USER_DOWN_RATE,     "down_rate",    INT32),\
}
...
extern void is_open_backscan(void);
/******************************************************************************/
extern int
...
#define debug_main_waring(fmt, args...)          um_debug_waring(main, fmt, ##args)
