...
/* Generated by 'tcpdump -dd udp dst port 3000' */
static struct sock_filter sync_sock_filter_insns[] = {
    { 0x28, 0, 0, 0x0000000c },
    { 0x15, 0, 4, 0x000086dd },
    { 0x30, 0, 0, 0x00000014 },
...
static const struct sock_fprog sync_sock_filter = {
	.len = ARRAY_SIZE(sync_sock_filter_insns),
	.filter = sync_sock_filter_insns,
};
				...
				enum l2_packet_filter_type type)
{
	...
	case L2_PACKET_FILTER_NDISC:
		...
		break;
	case L2_PACKET_FILTER_SYNC:
		sock_filter = &sync_sock_filter;
		break;
